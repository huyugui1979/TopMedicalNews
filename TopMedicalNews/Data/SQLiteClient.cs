...
namespace TopMedicalNews
{
	...
	public class SQLiteClient:ISQLiteClient
	{
		...
		void AddTestData()
		{
			...
			column.Add (new Column{ Title = "肿瘤综合科", ID = 33 ,CategoryID=6});
		...
		public  void DeleteData<T> (object data)
		{
